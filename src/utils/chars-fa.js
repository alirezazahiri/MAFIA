  ...
  },
  {
    ...
    html: `
      <div>
        <div>
          <p>او 8 معجون دارد</p> 
          <p><span>مرگ</span></br> بازیکن را حذف میکند </p>
          <p><span>شهروند کش</span></br> گرداننده یک شهروند را به طور تصادفی انتخاب و حذف میکند </p>
          <p><span>مافیا کش</span></br> گرداننده یک مافیا را به طور تصادفی انتخاب و حذف میکند</p>
          <p><span>افشا</span></br> بازیکنی که این معجون به او داده شده است باید نقشش را به طور واضح به همه بگوید</p>
          <p><span>بیمار کننده</span></br>  بازیکنی که این معجون به او داده شده بدون هیچ علامتی بعد از 48 ساعت در وسط روز از بازی حذف میشود(بیماری واگیردار نیست) </p>
          <p><span>جنون آور</span></br> با استفاده از این معجون بازیکن نمیتواند از قابلیتش در شب استفاده کند و  به جای آن باید یک نفر را انتخاب کند تا آن شخص از بازی حذف شود و خودش هم به مدت 24 ساعت ساکت می ماند</p>
          <p>نامیرایی</span></br> دو معجون نامیرایی دارد که باعث میشود از بازی حذف نشود (مگر در رای گیری)</p>
        </div>
      </div>
      `,
    max: 1,
...
// class="p-2" style="border: 0.5px solid #5C527F; border-radius: 12px; background: rgba(0, 0, 0, 0.2);" div
// style="text-align: center; border-bottom: 1px solid #5C527F; color: #5C527F;" first p
// style="text-align: center; border-bottom: 1px solid rgba(0, 0, 0, 0.2);" middle 5 ps
// style="text-align: center;"><span style="color: #5C527F;" last p
// style="color: #5C527F;" span
